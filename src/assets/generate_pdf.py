...
def draw_slide_decorations(canvas, doc):
    ...
    canvas.drawString(280, 28, "Summer Internship Research Project | Advisor: Dr. Laxmikant Yadav")
...
def build_presentation_pdf(output_filename):
    ...
    meta_data = [
        ...
        [Paragraph("<b>Academic Advisor:</b>", body_style), Paragraph("Dr. Laxmikant Yadav", body_style)],
