    ...
    <div className="flex flex-col h-full bg-white select-none">
      <div className="border-b border-[#D6D9DE] px-4 py-3 bg-[#E9ECEF]">
        <h3 className="text-[14px] font-bold text-[#2D3748] uppercase tracking-wider">
          ⚙️ Control Panel (System Inputs)
        </h3>
        <p className="text-[11px] text-[#6B7280] mt-0.5 font-normal">
          Configure process, regeneration, and wheel parameters
        </p>
      </div>
      <div className="p-5">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-3">
            <div className="border-b border-[#D6D9DE] pb-1">
              <h4 className="text-[13px] font-bold text-[#C62828] tracking-wider uppercase">
                2. Regeneration Stream
              </h4>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <Input
          ...
          {/* Group 3: Wheel Geometry */}
          <div className="space-y-3">
            <div className="border-b border-[#D6D9DE] pb-1">
              <h4 className="text-[13px] font-bold text-[#6B7280] tracking-wider uppercase">
                3. Wheel Geometry & Speed
              </h4>
            </div>
